      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="inline-flex h-auto w-full sm:w-auto items-center justify-start gap-2 rounded-2xl border border-slate-700/50 bg-slate-900/80 backdrop-blur-2xl p-1.5 shadow-2xl">
            ...
            <TabsTrigger
              value="transacoes"
              className="group relative px-4 py-2.5 text-sm font-semibold rounded-xl transition-all duration-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-violet-500 data-[state=active]:to-purple-500 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-violet-500/50 text-slate-400 hover:text-slate-200 hover:bg-slate-800/50"
            >
            ...
            <TabsTrigger
              value="despesas"
              className="group relative px-4 py-2.5 text-sm font-semibold rounded-xl transition-all duration-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-rose-500 data-[state=active]:to-red-500 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-rose-500/50 text-slate-400 hover:text-slate-200 hover:bg-slate-800/50"
            >
