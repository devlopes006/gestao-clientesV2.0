    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <Link target="_blank" href="https://devlops.sentry.io/issues/?project=4510386587500544">Issues Page</Link>.
          For more details about setting up Sentry, <Link target="_blank"
            href="https://docs.sentry.io/platforms/javascript/guides/nextjs/">read our docs</Link>.
        </p>
