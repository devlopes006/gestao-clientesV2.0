...
export class CostTrackingService {
  ...
  /**
   * Cria um novo item de custo interno
   */
  ...
  static async deleteCostItem(
    ...
    return prisma.costItem.update({
      ...
      data: {
        active: false,
        // keep audit trail for who deactivated, if field exists in schema
  ...
  /**
   * Cria uma nova associação de custo a cliente
   */
  ...
  /**
   * Materializa custos internos do mês
   */
  static async materializeMonthly(orgId: string, createdBy?: string) {
    ...
    // Busca associações ativas no período
  ...
  /**
   * Calcula margem de lucro por cliente
   */
